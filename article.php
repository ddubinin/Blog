          ...
          <section class="content__left col-md-8">
            <div class="block">              
              ...
              <div class="block__content">                
                <div class="full-text">
                  Зпрашиваемая вами статья не существует
                </div>
              </div>
            </div> 
          </section>
        ...
        <div class="row">
          <section class="content__left col-md-8">
            ...
            <div id="#comment-add-form" class="block">
              <h3>Добавиить комментарии</h3>
              <div class="block__content">
                <form action="article.php?id=<?php echo $art['id']; ?>#comment-add-form" class="form" method="POST">
                  <?php 
                  ...
                  <div class="form__group">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="nickname" class="form__control" placeholder="Никнайм" value="<?php echo $_POST['nickname']; ?>">
                      </div>
                      <div class="col-md-4">
